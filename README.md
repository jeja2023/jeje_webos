...
| **💬 反馈 (Feedback)** | 用户反馈系统，支持提交、查看、回复、全流程状态追踪及 WebSocket 实时通知 |
| **📁 文件管理 (FileManager)** | 全功能云端文件管理，支持文件夹多级嵌套、文件夹批量上传下载、在线预览、多选批量操作与拖拽上传 |
...
| **📚 知识库 (Knowledge)** | 企业级知识管理，支持向量检索、RAG 增强搜索、文档语义分析及解析任务中止控制 |
...
| **🎬 视频 (Video)** | 个人视频库，支持视频集分类、封面抓取、在线流媒体播放及重构的上传流程 |
...
- **自动化测试**: 核心业务模块 100% 单元测试覆盖 (840+ 测试用例)
- **主题系统**：2套可选特色主题（日出印象、星夜霓虹）
- **合规支持**：支持 ICP 备案及公安备案号动态展示，自动渲染图标与查询链接
