...
class AnalysisPage extends Component {
    ...
    renderViewer() {
        const { currentDataset, data, columns, total, filteredTotal, page, size, loading, search, sort } = this.state;
        ...
        if (sort) {
            sort.split(',').forEach((part, idx) => {
                ...
                sortFields[field] = { order, priority: idx + 1 };
            });
        }
                    ...
                    <div class="flex-between mb-15">
                        <div class="flex-center">
                            ...
                            <span class="text-secondary ml-15" style="font-size: 13px;">
                                ${search ? `筛选结果: ${displayTotal} / ${total} 条` : `共 ${total} 条数据`}
                            </span>
                        </div>
                    </div>
            ...
            return `<td>${Utils.escapeHtml(String(displayVal))}</td>`;
                ...
                <div class="p-15 border-top bg-primary flex-between">
                    <span class="text-secondary" style="font-size: 13px;">
                        第 ${(page - 1) * size + 1} - ${Math.min(page * size, displayTotal)} 条，共 ${displayTotal} 条
                    </span>
                    <div class="flex-center gap-5">
                        ...
                        <span class="mx-10" style="font-size: 13px;">第 ${page} / ${totalPages || 1} 页</span>
