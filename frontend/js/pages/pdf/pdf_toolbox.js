        ...
        return `
            <div class="pdf-toolbox">
                ...
                <div class="pdf-tool-grid">
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleMerge()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleSplit()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleCompress()">
                ...
                <div class="pdf-tool-grid">
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleRotate()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleExtractPages()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleDeletePages()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleReversePdf()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleAddPageNumbers()">
                ...
                <div class="pdf-tool-grid">
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleWatermark()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleRemoveWatermark()">
                        <div class="pdf-tool-icon"><i class="ri-eraser-line"></i></div>
                        <div class="pdf-tool-title">去除水印</div>
                        <div class="pdf-tool-desc">尝试移除水印</div>
                    </div>
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleEncrypt()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleDecrypt()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleSign()">
                ...
                <div class="pdf-tool-grid">
                    <div class="pdf-tool-card" onclick="window._pdfPage.handlePdfToWord()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handlePdfToExcel()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handlePdfToImages()">
                    ...
                    <div class="pdf-tool-card" onclick="window._pdfPage.handleImagesToPdf()">
